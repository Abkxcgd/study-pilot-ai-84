...
function CareerPage() {
  ...
  const [interview, setInterview] = useState<
    { question: string; type: string; sampleAnswer: string }[]
  >([]);
  ...
  const call = async (mode: "analyze" | "cover_letter" | "linkedin" | "interview") => {
    ...
    try {
      ...
      if (mode === "interview")
        setInterview((res as { questions: typeof interview }).questions ?? []);
    } catch (e) {
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Resume analysis, ATS scoring, cover letters, LinkedIn & interview prep.
          </p>
        </div>
      </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div>
            ...
            <Input
              ...
              placeholder="Paste JD keywords or link text"
            />
          </div>
        </div>
        <div>
          ...
          {coverLetter && (
            <div className="glass rounded-2xl p-6">
              <div className="flex justify-end mb-2">
                <Button size="sm" variant="ghost" onClick={() => copy(coverLetter)}>
