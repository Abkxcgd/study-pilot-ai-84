  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 prose prose-invert prose-headings:text-foreground">
        ...
        <p>You are responsible for keeping your credentials safe and for the activity that happens under your account. You must be at least 13 years old to use the service.</p>
        ...
        <ul>
          ...
          <li>Don't use the AI features to generate content that violates academic integrity policies at your institution.</li>
        </ul>

        <h2>4. AI-generated content</h2>
        <p>AI outputs may contain inaccuracies. You are responsible for reviewing and verifying AI-generated content before relying on it for exams, submissions, or decisions.</p>

        <h2>5. Subscriptions</h2>
        <p>Free plans have usage limits. Paid plans, when available, are billed as described at checkout and are non-refundable except where required by law.</p>
        ...
        <h2>8. Contact</h2>
        <p>For questions about these terms, email <a href="mailto:hello@studypilot.ai" className="text-primary-glow">hello@studypilot.ai</a>.</p>
      </main>
      <footer className="border-t border-border/50">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-8 text-sm text-muted-foreground">
          ...
          <div className="flex gap-6"><Link to="/privacy">Privacy</Link><Link to="/about">About</Link></div>
        </div>
      </footer>
    </div>
  );
