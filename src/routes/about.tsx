...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "The mission behind StudyPilot AI — helping students study smarter with AI.",
      },
      { property: "og:title", content: "About StudyPilot AI" },
      {
        property: "og:description",
        content: "Our mission: give every student a personal AI study companion.",
      },
      ...
      <main className="mx-auto max-w-4xl px-6 py-20">
        <div className="text-center">
          ...
          <h1 className="mt-6 text-5xl font-bold tracking-tight">
            Every student deserves an <span className="text-gradient">AI copilot</span>.
          </h1>
          <p className="mt-6 text-lg text-muted-foreground">
            StudyPilot AI was built by students, for students. We combine the best of generative AI
            with beautiful design to help you learn faster, stay organized, and hit your goals.
          </p>
        </div>
          ...
          {[
            {
              icon: Target,
              title: "Our mission",
              desc: "Democratize personalized learning through AI.",
            },
            { icon: Heart, title: "Our values", desc: "Simple. Fast. Private. Student-first." },
            {
              icon: Rocket,
              title: "Where we're going",
              desc: "The all-in-one operating system for modern learners.",
            },
          ].map((v) => (
        ...
        <div className="mt-20 glass rounded-3xl p-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
            Chat with an AI tutor, summarize any PDF, generate flashcards, plan your semester, and
            track your progress — all in one workspace crafted like Notion, Linear, and Apple would.
          </p>
